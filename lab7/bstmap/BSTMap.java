...
//    }
    ...
    @Override
    public boolean containsKey(K key) {
        return containsKeyHelper(sentinel, key);
    }
    ...
    private boolean containsKeyHelper(BSTnode node, K key) {
        ...
        if (cmp > 0) {
            return containsKeyHelper(node.rightchild, key);
        } else if (cmp < 0) {
            return containsKeyHelper(node.leftchild, key);
        } else {
            return true;
        }
    }
...
//    public
    ...
    public V remove(K key){
       ...
       V value =get(key) ;
       sentinel = removehelper(sentinel,key);
       size -=1;
       return value;
    }
    ...
    private BSTnode removehelper (BSTnode T, K key) {
        ...
        if( cmp > 0) {
            T.rightchild = removehelper(T.rightchild , key);
        } else if ( cmp < 0) {
            T.leftchild = removehelper(T.leftchild , key) ;
        } else {
            if (T.leftchild == null) {
                return T.rightchild;
            }
            ...
            BSTnode temp = T;
            T = minNode (temp.rightchild) ;
            T.rightchild= removeMin(temp.rightchild) ;
            T.leftchild = temp.leftchild;
        }
        return T;
    }
